...
\begin{itemize}
    \item \textbf{Books:} \textit{Computer Networking: A Top-Down Approach} by James F. Kurose and Keith W. Ross; \textit{Computer Networks} by Andrew S. Tanenbaum.
    \item \textbf{Course Material:} Class lectures and notes from ITL351 Computer Networks Lab.
    \item \textbf{AI Assistants:} OpenAI's ChatGPT and Anthropic's Claude were used as reference tools for understanding protocols, debugging, and documentation formatting.
\end{itemize}
